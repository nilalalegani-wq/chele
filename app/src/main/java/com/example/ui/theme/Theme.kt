...
// Rebuilt to match the "چله زیارت عاشورا" night-sky reference screenshot exactly:
// deep navy background, glowing sky-blue accent, soft blue-tinted cards/borders.
private val BlueDarkColorScheme = darkColorScheme(
    primary = Color(0xFF4A93FF),              // glowing accent blue (progress ring, CTA circle, active nav)
    onPrimary = Color.White,
    primaryContainer = Color(0xFF1D3A66),      // active/selected day card fill
    onPrimaryContainer = Color(0xFFDCE8FF),
    secondary = Color(0xFF1B4DB0),             // deep blue used at the tail of the CTA gradient
    onSecondary = Color.White,
    tertiary = Color(0xFF4CD97B),              // completed-day success ring
    onTertiary = Color(0xFF07230F),
    background = Color(0xFF0A0F1F),            // near-black navy app background
    onBackground = Color(0xFFEAF1FF),
    surface = Color(0xFF12192E),               // base card surface
    onSurface = Color(0xFFEAF1FF),
    surfaceVariant = Color(0xFF141B33),        // progress card / hero caption panel
    onSurfaceVariant = Color(0xFF93A0C2),      // muted secondary text ("شروع نشده" etc.)
    outline = Color(0xFF2A3555),               // card borders, locked-day icon circle
